...
class AILifePlatformApp {
    ...
    async initializeEngines() {
        ...
        // Instantiate and expose Quantum Neuromorphic Intelligence globally
        if (!window.QuantumNeuromorphicIntelligence) {
            console.log('🧠⚛️ Instantiating Quantum Neuromorphic Intelligence...');
            window.QuantumNeuromorphicIntelligence = new QuantumNeuromorphicIntelligence();
            await window.QuantumNeuromorphicIntelligence.init(); // already called in constructor, but safe
            console.log(`🧠⚛️ QuantumNeuromorphicIntelligence v${window.QuantumNeuromorphicIntelligence.version} instantiated`);
        } else {
            console.log('🧠⚛️ QuantumNeuromorphicIntelligence already present');
        }
        
        // Now initialize Quantum Intelligence Engine
